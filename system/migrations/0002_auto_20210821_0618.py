# Generated by Django 3.2.6 on 2021-08-20 23:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_monhoc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='system.monhoc')),
            ],
        ),
        migrations.CreateModel(
            name='diemdanh',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.CharField(choices=[(1, 'quantri'), (2, 'giangvien'), (3, 'sinhvien')], default=1, max_length=8)),
