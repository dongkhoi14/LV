...
urlpatterns = [
    ...
    path('getStaffHistorycheckin', HistoryCheckinAPI.as_view()),

    path('api/event/history', departmentHistoryEventAPI.as_view()),
    path('api/event/history/checkin', StaffEventCheckinAPI.as_view()),
    path('api/event/history/checkout', StaffEventCheckoutAPI.as_view()),
    path('ListStaffAtt',ListStaffAtt.as_view()),
    path('api/staff/history/in',StaffInAPI.as_view()),
    path('api/staff/history/out',StaffOutAPI.as_view()),



    # Enterprise
    path('adminEnterprise', views.adminEnterprise, name='adminEnterprise'),
    path('adminEnterpriseManager', adminEnterpriseManager,
         name="adminEnterpriseManager"),
    ...
    path('historystaffattevent', historystaffattevent,
         name='historystaffattevent'),
